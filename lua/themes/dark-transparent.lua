...
function theme.setup()
	...
	vim.api.nvim_set_hl(0, "Function", { fg = "#00ff4e", bold = true })
	...
	vim.api.nvim_set_hl(0, "Tag", { fg = "#8b43c5", bold = true })
	vim.api.nvim_set_hl(0, "Identifier", { fg = "#00ff4e", bold = true })
	vim.api.nvim_set_hl(0, "Delimiter", { fg = "#ffa500" })
	vim.api.nvim_set_hl(0, "PunctuationBracket", { fg = "#00e5ff" })
	vim.api.nvim_set_hl(0, "Special", { fg = "#00ff4e", bold = true })
