...
M.setup = function(colors)
  ...
  vim.cmd(string.format(
    [[
  highlight LualineBufferActive guifg=%s guibg=%s
  highlight LualineBufferInactive guifg=%s guibg=%s
  highlight WinbarLeftIndent guifg=%s guibg=NONE
  highlight WinbarNormal guifg=%s guibg=NONE
  highlight WinbarComponent guifg=%s guibg=NONE
]], colors.buffer_active_fg, colors.buffer_active_bg, colors.buffer_inactive_fg, colors.buffer_inactive_bg,
    colors.winbar_left_fg, colors.winbar_fg, colors.winbar_fg))
  ...
  lualine.setup({
    options = {
      ...
      disabled_filetypes = {
        ...
        winbar = { "neo-tree", "lazy", "neo-tree filesystem [1]", "toggleterm", "dap-repl", "dapui_scopes", "dapui_stacks", "dapui_breakpoints", "dapui_watches", "dapui_console", "dapui_hover" },
      },
